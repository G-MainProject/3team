                ...
                <div className='section-container'>
                    ...
                    <div className='ai-analysis-container'>
                        <div className='ai-analysis-content'>
                            <h3>종합 분석</h3>
                            <p>
                                현재 시장 상황을 종합적으로 분석한 결과, 삼성전자는 AI 반도체 수요 증가와 
                                글로벌 공급망 안정화로 인해 중장기적으로 긍정적인 전망을 보이고 있습니다. 
                                특히 메모리 반도체 분야에서의 기술적 우위와 시스템 반도체 확장 전략이 
                        ...
                        <div className='ai-prediction'>
                            ...
                            <div className='prediction-item'>
                                ...
                                <span className='prediction-value positive'>강력 매수</span>
                            </div>
                            <div className='prediction-item'>
                                <span className='prediction-label'>장기 (6개월+):</span>
                                <span className='prediction-value positive'>보유</span>
                            </div>
                        </div>
                    </div>
                    </div>
